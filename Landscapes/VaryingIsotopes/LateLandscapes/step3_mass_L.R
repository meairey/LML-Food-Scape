...
save(file = "Data/VaryingIsotopesData/LateData/observed_lengths_late.RData", observed_lengths.late)
...
save(file = "Data/VaryingIsotopesData/LateData/n_obs_mass_late.RData", n_obs_mass.late)
