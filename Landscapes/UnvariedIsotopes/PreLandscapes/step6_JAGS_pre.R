...
load("Data/VaryingIsotopesData/PreData/Pre_arraydata.RData")
...
#### Load in covariates -------------------
load("Data/VaryingIsotopesData/PreData/habs_cov.RData")
load("Data/VaryingIsotopesData/PreData/covariate_temp.RData")
load("Data/VaryingIsotopesData/PreData/z_covariate.RData")
# Jags Data
alpha <- 1
# Jags Data
beta <- 1
