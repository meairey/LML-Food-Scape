...
chains <- as.mcmc.list(jags_output.early.un) ## set chains
...
names = (data.frame(colnames = colnames(jags_output.early.un[[1]]))  %>%
...
save(file = "Data/UnvariedIsotopeData/posterior_early.unvaried.csv", posterior.early.unvaried)
